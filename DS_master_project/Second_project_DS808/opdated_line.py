...
Color_line = 'black'
text_font= 'Arial, Helvetica, sans-serif'                     #####IDA
text_color = "rgba(31,34,34,1.00)"
...
app.layout = html.Div(children=[
    ...
    style={'backgroundColor':Background_html,
           "background-font":text_color} #change the texttype on the baggrund and not on the graphs
)
...
def update_output_div(input_value, components1):
    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Div(children=[
                html.Div('{} DKK'.format(secondValue_m)),##################################################################################################
                    html.Div(explanation)
                ])
            ], className="payGapGridItem"),
    ...
    if years_chosen[0] != years_chosen[1]:
        ...
        if user_salary!=0 and user_salary is not None and user_salary!='':
            ...
            fig=px.line(df_plot,
                        ...
                        title={
            'text' : "Difference in procent for "+str(years_chosen[0])+" to "+str(years_chosen[1]),
            'x':0.5,
            'xanchor': 'center',
        }
                        )
...
def Brance_scatter(years_chosen, wage, sort, user_wage, user_industry):
    ...
    fig3.update_layout(title_text="The gender pay gap in different industries")
