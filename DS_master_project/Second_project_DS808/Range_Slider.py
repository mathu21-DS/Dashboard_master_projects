...
image_filename = 'assets/men-128.1.jpg'  # replace with your own image
...
app.layout = html.Div(children=[
    ...
    html.Div([
        html.Div(children=[
            ...
            html.Div(children=[
                html.Div(children=[
                    html.H4('Women are, on average, earning '),
                    html.H3(
                ...
                html.Div([
                    ...
                    dcc.Dropdown(
                        ...
                        options=[{"label": x, "value": x}
                                 for x in list(df1["Industry"].unique())],
            ...
            html.Div([
                html.Label(['Look deeper into one industry:'],
    ...
    html.Div([
        html.Div([
            dcc.Graph(
                id='emp_g_graph',
                style={'width': '33', 'height': '650px', 'backgroundColor':Background}
            )
        ],
    ...
    style={'backgroundColor':Background, 'fant-family': text_font} #change the texttype on the baggrund and not on the graphs
)
...
def Brance_scatter(years_chosen, wage, sort, user_wage, user_industry):
    ...
    if wage == "STANDARDIZED HOURLY EARNINGS":
        ...
        fig_line = px.scatter(x=((df_scatmen["Contents Men"]+df_scatwomen["Contents Women"])/2),
                              y=industries, custom_data=[df_diffscat[0]])
        fig_line.update_traces(hovertemplate='The difference in mean hourly wage between men and women in the %{y} industry is %{customdata[0]} DKK',
        ...
        fig_line = px.scatter(x=((df_scatmen["Contents Men"]+df_scatwomen["Contents Women"])/2),
                              y=industries, custom_data=[df_diffscat[0]])
        fig_line.update_traces(hovertemplate='The difference in mean monthly wage between men and women in the %{y} industry is %{customdata[0]} DKK', marker=dict(size=0.1,
                                                                                                                                                                   line=dict(width=0.1,
                                                                                                                                                                             color=Color_line)),
                               selector=dict(mode='markers'))
...
def update_bargraph1(years_chosen, components2):
    # print(years_chosen,"years_chosen")
...
# link to style and understand barchard: https://www.youtube.com/watch?v=N1GwQNatOwo&list=PLh3I780jNsiTXlWYiNWjq2rBgg3UsL1Ub&index=2
    ...
    barchart1.update_layout(showlegend=False,paper_bgcolor=Background)
...
def update_bargraph2(years_chosen, components2):
    # get each value from the rangeslide list which is saved in id: intermediate-value
...
# link to style and understand barchard: https://www.youtube.com/watch?v=N1GwQNatOwo&list=PLh3I780jNsiTXlWYiNWjq2rBgg3UsL1Ub&index=2
    ...
    barchart1 = px.bar(
        data_frame=dff2,  # it only show the 5 highest gap pay between men and women
        x="Earnings types per standard hour",
...
def overtime_data(years_chosen, wage, industrie):
   ...
   # df_box = df_box[(df_box["Industry"] == "Manufacturing")]
    ...
    men_general_manager_mean = men_general_manager_df.iloc[3] #mean is STANDARDIZED HOURLY EARNINGS 
    men_general_manager_median = men_general_manager_df.iloc[1]
    men_general_manager_q1 = men_general_manager_df.iloc[0] #lower quartile
    men_general_manager_q3 = men_general_manager_df.iloc[4]
    men_general_manager_IQR = (men_general_manager_q3 - men_general_manager_q1)
    men_general_manager_lowerfence = men_general_manager_q1 - (1.5*men_general_manager_IQR)
    men_general_manager_upperfence = men_general_manager_q3 + (1.5*men_general_manager_IQR)
    
    
    women_general_manager_mean = women_general_manager_df.iloc[3] #mean is STANDARDIZED HOURLY EARNINGS 
    women_general_manager_median = women_general_manager_df.iloc[1]
    women_general_manager_q1 = women_general_manager_df.iloc[0] #lower quartile
    women_general_manager_q3 = women_general_manager_df.iloc[4]
    women_general_manager_IQR = (women_general_manager_q3 - women_general_manager_q1)
    women_general_manager_lowerfence = women_general_manager_q1 - (1.5*women_general_manager_IQR)
    women_general_manager_upperfence = women_general_manager_q3 + (1.5*women_general_manager_IQR)
    ...
    men_employees_non_managers_mean = men_employees_non_managers_df.iloc[3] #mean is STANDARDIZED HOURLY EARNINGS 
    men_employees_non_managers_median = men_employees_non_managers_df.iloc[1]
    men_employees_non_managers_q1 = men_employees_non_managers_df.iloc[0] #lower quartile
    men_employees_non_managers_q3 = men_employees_non_managers_df.iloc[4]
    men_employees_non_managers_IQR = (men_employees_non_managers_q3 - men_employees_non_managers_q1)
    men_employees_non_managers_lowerfence = men_employees_non_managers_q1 - (1.5*men_employees_non_managers_IQR)
    men_employees_non_managers_upperfence = men_employees_non_managers_q3 + (1.5*men_employees_non_managers_IQR)


    women_employees_non_managers_mean = women_employees_non_managers_df.iloc[3] #mean is STANDARDIZED HOURLY EARNINGS 
    women_employees_non_managers_median = women_employees_non_managers_df.iloc[1]
    women_employees_non_managers_q1 = women_employees_non_managers_df.iloc[0] #lower quartile
    women_employees_non_managers_q3 = women_employees_non_managers_df.iloc[4]
    women_employees_non_managers_IQR = (women_employees_non_managers_q3 - women_employees_non_managers_q1)
    women_employees_non_managers_lowerfence = women_employees_non_managers_q1 - (1.5*women_employees_non_managers_IQR)
    women_employees_non_managers_upperfence = women_employees_non_managers_q3 + (1.5*women_employees_non_managers_IQR)
    ...
    men_employees_total_mean = men_employees_total_df.iloc[3] #mean is STANDARDIZED HOURLY EARNINGS 
    men_employees_total_median = men_employees_total_df.iloc[1]
    men_employees_total_q1 = men_employees_total_df.iloc[0] #lower quartile
    men_employees_total_q3 = men_employees_total_df.iloc[4]
    men_employees_total_IQR = (men_employees_total_q3 - men_employees_total_q1)
    men_employees_total_lowerfence = men_employees_total_q1 - (1.5*men_employees_total_IQR)
    men_employees_total_upperfence = men_employees_total_q3 + (1.5*men_employees_total_IQR)
    
    
    women_employees_total_mean = women_employees_total_df.iloc[3] #mean is STANDARDIZED HOURLY EARNINGS 
    women_employees_total_median = women_employees_total_df.iloc[1]
    women_employees_total_q1 = women_employees_total_df.iloc[0] #lower quartile
    women_employees_total_q3 = women_employees_total_df.iloc[4]
    women_employees_total_IQR = (women_employees_total_q3 - women_employees_total_q1)
    women_employees_total_lowerfence = women_employees_total_q1 - (1.5*women_employees_total_IQR)
    women_employees_total_upperfence = women_employees_total_q3 + (1.5*women_employees_total_IQR)
    ...
    if wage == "STANDARDIZED HOURLY EARNINGS":
        ...
        ##MANAGERS
        men_general_manager_mean_2 =men_general_manager_mean*recalculate #mean is STANDARDIZED HOURLY EARNINGS 
        men_general_manager_median_2 = men_general_manager_median *recalculate
        men_general_manager_q1_2 = men_general_manager_q1*recalculate
        men_general_manager_q3_2 = men_general_manager_q3*recalculate
        men_general_manager_IQR_2 = (men_general_manager_q3_2 - men_general_manager_q1_2)
        men_general_manager_lowerfence_2 = men_general_manager_q1_2 - (1.5*men_general_manager_IQR_2)
        men_general_manager_upperfence_2 = men_general_manager_q3_2 + (1.5*men_general_manager_IQR_2)
        
        
        women_general_manager_mean_2 = women_general_manager_mean*recalculate #mean is STANDARDIZED HOURLY EARNINGS 
        women_general_manager_median_2 = women_general_manager_median*recalculate
        women_general_manager_q1_2 = women_general_manager_q1*recalculate #lower quartile
        women_general_manager_q3_2 = women_general_manager_q3*recalculate
        women_general_manager_IQR_2 = (women_general_manager_q3_2 - women_general_manager_q1_2)
        women_general_manager_lowerfence_2 = women_general_manager_q1_2 - (1.5*women_general_manager_IQR_2)
        women_general_manager_upperfence_2 = women_general_manager_q3_2 + (1.5*women_general_manager_IQR_2)
        
        
        #Employees non managers
        men_employees_non_managers_mean_2 = men_employees_non_managers_mean *recalculate#man is STANDARDIZED HOURLY EARNINGS 
        men_employees_non_managers_median_2 =men_employees_non_managers_median*recalculate
        men_employees_non_managers_q1_2 = men_employees_non_managers_q1*recalculate#lower quartile
        men_employees_non_managers_q3_2 =men_employees_non_managers_q3 *recalculate
        men_employees_non_managers_IQR_2 = (men_employees_non_managers_q3_2 - men_employees_non_managers_q1_2)
        men_employees_non_managers_lowerfence_2 = men_employees_non_managers_q1_2 - (1.5*men_employees_non_managers_IQR_2)
        men_employees_non_managers_upperfence_2 = men_employees_non_managers_q3_2 + (1.5*men_employees_non_managers_IQR_2)


        women_employees_non_managers_mean_2 = women_employees_non_managers_mean *recalculate #mean is STANDARDIZED HOURLY EARNINGS 
        women_employees_non_managers_median_2 =  women_employees_non_managers_median*recalculate
        women_employees_non_managers_q1_2 =   women_employees_non_managers_q1*recalculate#lower quartile
        women_employees_non_managers_q3_2 =  women_employees_non_managers_q3*recalculate
        women_employees_non_managers_IQR_2 = (women_employees_non_managers_q3_2 - women_employees_non_managers_q1_2)
        women_employees_non_managers_lowerfence_2 = women_employees_non_managers_q1_2 - (1.5*women_employees_non_managers_IQR_2)
        women_employees_non_managers_upperfence_2 = women_employees_non_managers_q3_2 + (1.5*women_employees_non_managers_IQR_2)
      
        
        #total employees
        men_employees_total_mean_2 = men_employees_total_mean *recalculate #mean is STANDARDIZED HOURLY EARNINGS 
        men_employees_total_median_2 =men_employees_total_median *recalculate
        men_employees_total_q1_2 =  men_employees_total_q1 *recalculate#lower quartile
        men_employees_total_q3_2 = men_employees_total_q3 *recalculate
        men_employees_total_IQR_2 = (men_employees_total_q3_2 - men_employees_total_q1_2)
        men_employees_total_lowerfence_2 = men_employees_total_q1_2 - (1.5*men_employees_total_IQR_2)
        men_employees_total_upperfence_2 = men_employees_total_q3_2 + (1.5*men_employees_total_IQR_2)
        
        
        women_employees_total_mean_2 =women_employees_total_mean *recalculate #mean is STANDARDIZED HOURLY EARNINGS 
        women_employees_total_median_2 =women_employees_total_median *recalculate
        women_employees_total_q1_2 =women_employees_total_q1*recalculate#lower quartile
        women_employees_total_q3_2 = women_employees_total_q3 *recalculate
        women_employees_total_IQR_2 = (women_employees_total_q3_2 - women_employees_total_q1_2)
        women_employees_total_lowerfence_2 = women_employees_total_q1_2 - (1.5*women_employees_total_IQR_2)
        women_employees_total_upperfence_2 = women_employees_total_q3_2 + (1.5*women_employees_total_IQR_2)
    ...
    if wage == "STANDARDIZED HOURLY EARNINGS":
        fig_output = go.Figure(data=fig1_gns.data + fig2_gns.data + fig3_gns.data + fig4_gns.data + fig5_gns.data + fig6_gns.data)
        fig_output.update_layout(showlegend = False, paper_bgcolor=Background)
        fig_output.update_layout(yaxis_title = 'Hourly wage in DKK', xaxis_title = 'Employment Group')
        
    else:
        fig_output = go.Figure(data=fig1_gns_2.data + fig2_gns_2.data + fig3_gns_2.data + fig4_gns_2.data + fig5_gns_2.data + fig6_gns_2.data)
        fig_output.update_layout(showlegend = False, paper_bgcolor=Background)
        fig_output.update_layout(yaxis_title = 'Monthly wage in DKK', xaxis_title = 'Employment Group')
    
    fig_output.update_layout(title={'text':"Illustration of wage for employment groups based on gender for the " + str(industrie)+" industry",  'y':0.9,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'})
...
Plot_back='rgba(0,0,0,0)'
Text_type='Open Sans Regular'
Color_women='rgba(178,0,147,0.9)' #'rgba(178,0,147,255)'
Color_men='rgba(1,175,175,0.9)'
Color_user = 'rgba(254,162,2,255)'
Color_line = 'black'
text_font= 'sans-serif'                     #####IDA
...
app.layout = html.Div(children=[
    ...
    html.Div([
        html.Div(children=[
            ...
            html.Div(children=[
                html.Div(children=[
                    html.H4('Women are earning on average'),
                    html.H3(
                        id='average_pay_difference',
                    ),
                    html.H4('less then men.')
...
def Sector_plot(years_chosen, components):
    ...
    if years_chosen[0] != years_chosen[1]:
        ...
        df_sector = df_sector[(df_sector["Year"] >= years_chosen[0]) & (
            df_sector["Year"] <= years_chosen[1])]

        fig = px.line(df_sector, x="Year",
                      y="Difference in procents", color="Sector")
        ...
        barchart_two.update_layout(legend=dict(
            legend=dict(
                x=0.7,
                y=1,
                title_font_family="Times New Roman",
...
# link to style and understand barchard: https://www.youtube.com/watch?v=N1GwQNatOwo&list=PLh3I780jNsiTXlWYiNWjq2rBgg3UsL1Ub&index=2
    ...
    barchart1 = px.bar(
        ...
        labels={'value':'Number of peoples'},
        hover_data={'Difference in men and women working in the industry',
                    'Procent of men in the industry','Procent of women in the industry'}
        ,                         # in 'group' mode, bars are placed beside each other.
                                # in 'relative' mode, bars are stacked above (+) or below (-) zero.
        title="Employees in the " +str(components2) +' industry'
    )
    barchart1.update_layout(showlegend=False,paper_bgcolor=Background)
    barchart1.update_layout(uniformtext_minsize=8, uniformtext_mode='hide')
...
@app.callback(
    Output(component_id='overtime_graph', component_property='figure'), #show the graph
    Input(component_id='intermediate-value', component_property='data'), #of the year interval #the data is connected to the input which the input is is connected to the layout
    #Input(component_id='intermediate-value4', component_property='data'), #of the choosen montly or hourly
    Input(component_id='intermediate-value3', component_property='data') #of the choosen branche
)

def overtime_data(years_chosen, industrie):


    df_box = df1
    df_box = df_box[(df_box["Year"] >= years_chosen[0]) & ( df_box["Year"] <= years_chosen[1])]
    df_box = df_box[(df_box["Industry"] == str(industrie))]
    #df_box = df_box[(df_box["Industry"] == "Agriculture, forestry and fishing")]
    ...
    fig5_gns.add_trace(
    go.Box(
        x=["Employees, non-managerial level (Men)"],
        #name="Employees, non-managers- men",
        marker_color=Color_men))
    ...
    fig6_gns.add_trace(
    go.Box(
        x=["Employees, non-managerial level (Women)"],
        #name="Employees, non-managers - women",
        marker_color=Color_women))
